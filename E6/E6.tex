...
\begin{tikzpicture}[
	...
	vector help/.style={very thin, dash pattern={on 2pt off 2pt on 2pt off 2pt}},
]
...
\coordinate (Ax) at (2.1, 0, 0);
\coordinate (Ay) at (0, 1.4, 0);

\coordinate (B) at (0, 1.4, 2.35);
\coordinate (By) at (0, 1.4, 0);
\coordinate (Bz) at (0, 0, 2.35);

\coordinate (C) at (2.1, 0, 2.35);
\coordinate (Cx) at (2.1, 0, 0);
\coordinate (Cz) at (0, 0, 2.35);
...
\draw[vector help] (A) -- (Ax);
\draw[vector help] (A) -- (Ay);

\draw[vector help] (B) -- (By);
\draw[vector help] (B) -- (Bz);

\draw[vector help] (C) -- (Cx);
\draw[vector help] (C) -- (Cz);
