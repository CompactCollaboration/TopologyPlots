...
\draw[vector help one] (A) -- (Ax);
\draw[vector help one] (A) -- (Ay);

\draw[vector help one] (B) -- (By);
\draw[vector help one] (B) -- (Bz);

\draw[vector help one] (C) -- (Cx);
\draw[vector help one] (C) -- (Cz);
